...
export function buildEmailMessages(
  ...
  const system = [
    ...
    "- Mine WHAT THE USER ACTUALLY SAID in the brief before writing a word. The",
    "  details they volunteered, the way they describe their own work, the",
    "  offhand remark about a customer: that is the material that makes this",
    "  email theirs and not interchangeable with every other brand's. Prefer",
    "  their concrete noun to your abstract one, and echo their vocabulary. A",
    "  draft that could have been written without ever reading that block is a",
    "  failed draft.",
