...
export const EMAIL_STYLES: Record<EmailStyleId, EmailStyleDirective> = {
  soft_card: {
    ...
    lines: [
      ...
      "- Eyebrow: a small uppercase accent-colored kicker above the headline.",
      "- Accent bar: a 5px solid accent-colored top bar across the card gives it brand presence.",
      "- Headline: 28 to 32px, bold, tight letter-spacing.",
      "- Callouts/dividers: soft-tint callout boxes with a rounded accent left border; thin hairline dividers between sections.",
  ...
  bold_accent_band: {
    ...
    lines: [
      ...
      "- Headline: large (32px+), heavy weight, high contrast.",
      "- Callouts: bold-bordered boxes (solid accent border on all sides), square corners.",
      "- CTA: a large, high-contrast rectangular button, sharp corners.",
      "- Accent: strong and deliberate across the band, CTA, and one more element. The band's <td> MUST also carry a solid bgcolor attribute in the accent color (Outlook ignores CSS gradients/backgrounds on styled elements but honors the bgcolor attribute), so it still reads as a bold accent bar even there.",
  ...
  bordered_ledger: {
    ...
    lines: [
      ...
      "- Accent: restrained, mostly on borders and the CTA.",
  ...
  left_rule_editorial: {
    ...
    lines: [
      ...
      "- Eyebrow: an uppercase accent label, indented to match.",
  ...
  pill_modern: {
    ...
    lines: [
      ...
      "- Eyebrow: a small rounded PILL/chip badge (accent-tinted background, accent text, fully rounded corners) instead of a plain uppercase label.",
      "- Headline: bold, 28 to 32px, rounded/friendly type feel.",
      "- Callouts: soft rounded-corner tint boxes (16px radius), no hard borders.",
      "- CTA: a LARGE fully-rounded pill-shaped button (very high border-radius, e.g. 999px), the visual centerpiece of the email.",
      "- Accent: generous but soft, tints rather than hard blocks.",
  ...
  warm_gradient_top: {
    ...
    lines: [
      ...
      "- Eyebrow: an uppercase accent label just below the band.",
      "- Headline: bold, 28 to 32px.",
      "- Callouts: soft warm-tinted callout boxes, rounded corners.",
      ...
      "- Accent: warm and friendly, concentrated at the top band and CTA.",
