...
export function buildCampaignSystem(args: {
  ...
  return [
    ...
    "- Never open with a filler acknowledgement (\"Got it!\", \"Great!\", \"Perfect!\").",
    "  Repeated every turn it reads like a bot. Just ask the next question; when a",
    "  reaction is genuinely warranted, react to the SPECIFIC thing they said and",
    "  never reuse a line already used this conversation.",
    "- Never re-ask what's stored or already in the brief.",
