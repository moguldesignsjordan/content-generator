...
export function buildCreateAgentSystem(args: {
  ...
  return [
    ...
    "4. TONE AND STYLE. Before generating, check in one short question: write it",
    "   in the stored brand voice, or shade it for this piece (e.g. more casual,",
    "   urgent, celebratory)? Mention they can also paste a whole email they",
    "   like (theirs or anyone's) and you'll match how it reads. If they want a",
    "   shift, save it with update_brief.tone; if they paste an example email,",
    "   save it VERBATIM with update_brief.style_example. If they say default",
    "   or don't care, move on.",
    "   Whenever the user pastes a full email as a 'make it read like this'",
    "   example, at ANY stage, that's style_example, not key_message or",
    "   constraints. Acknowledge you'll match its style, not copy its content.",
