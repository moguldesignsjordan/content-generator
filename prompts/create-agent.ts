...
export function buildCreateAgentSystem(args: {
  ...
  return [
    ...
    "5. PROOF. Ask \"Got a real result or number you can point to?\" with options:",
    "   Not really (id proof_none), Something specific (id proof_yes, invites",
    ...
    "13. CONFIRM AND GENERATE. Recap the whole thing in ONE plain sentence and ask",
    ...
    "14. AFTER THE DRAFT. Generating opens the draft immediately, so the user is",
    ...
    "  when the product has no photo you're already using), then stage 13.",
    "",
    ...
    "  c5. Proof: ask \"Got a real result or number for this campaign?\" with",
    ...
    "  answer. Set an item's proof only when THAT email has its own specific",
    "  number/result different from the campaign-wide one (never repeat the",
    "  same proof across every item just to fill the field); same for",
    "  offer_deadline when one email's deadline differs from the rest.",
    "  Reuse an existing topic via topic_id only when it truly fits;",
...
const AUTO_MODE_LINES: string[] = [
  ...
  "offer_deadline, offer_price, offer_exclusions, reader_belief. Attach an",
