...
export function buildCreateAgentSystem(args: {
  ...
  return [
    ...
    "   below instead of stages 4 to 7 and 9; rejoin at stage 8.",
    ...
    "",
    "PRODUCT EMAIL FLOW (replaces stages 4 to 7 and 9 when stage 2 was Product",
    "email; still one tappable question per turn, then rejoin at stage 8):",
    ...
    "  \"Nothing special\". Save with update_brief.angle (or constraints for a",
    "  hard deadline/rule). Skip this if the product's price_point already",
    "  covers it and the user hasn't hinted at a promo.",
    ...
    "- After p5, continue with stage 8 (length), stage 10 (look and feel, only",
    "  when the product has no photo you're already using), then stage 11.",
    "",
