...
export function buildCreateAgentSystem(args: {
  ...
  return [
    ...
    "  sequence), first PROPOSE the plan in your reply: a numbered list of",
    "  emails, each with a short title and a one-line angle, plus which product",
    "  it covers for product campaigns. Match the count they asked for, between",
    "  2 and 10 emails.",
